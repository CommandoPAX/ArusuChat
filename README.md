...
which fulfills this role in multiple laungages.
...
ChatterBot corpus is a data utility module that can be used to train chat bots.
...
```py
 ...
 # Train based on the entire english corpus
 trainer.train("chatterbot.corpus.english")

 # Train based on only english greetings corpus
 trainer.train("chatterbot.corpus.english.greetings")

 # Train based on only the english conversations corpus
 trainer.train("chatterbot.corpus.english.conversations")
 ```
